      ...
      <SECTION id="column-1">
        ...
        <DIV class="lcars-list-2 uppercase">
          <UL>
            ...
            <LI class="oc-almond-creme go-almond-creme">
      ...
      <SECTION id="column-3">
        <DIV class="wrap">
          ...
          <DIV class="right-frame-top">
            <DIV class="banner">
              LCARS &#149; <SPAN class="blink">Online</SPAN>
            </DIV>
            <DIV class="data-cascade-button-group">
              ...
              <NAV>
                ...
                <A href="" id="b-four" class="go-away">04</A>
                <A href="" id="b-five">05</A>
              </NAV>
            </DIV>
        ...
        <DIV class="wrap" id="gap">
          ...
          <DIV class="right-frame">
            ...
            <MAIN>
              ...
              <H2>
                Welcome to LCARS <SPAN class="go-tomato">Ultra</SPAN>{" "}
                &#149; Classic Theme
              </H2>
              ...
              <FOOTER>
                <DIV class="footer-inside">
                  <DIV class="footer-text">
                    <P>
                      Content Copyright &#169; 2023 *replace this text with your
                      site's name or url*
                    </P>
                    <P>
